defprotocol ForkWithFlags.Group do
  @moduledoc """
  ...
  ## Example
      ...
      iex> ForkWithFlags.Group.in?(data, "staff")
      true
      iex> ForkWithFlags.Group.in?(data, "superusers")
      false
  """
...
defimpl ForkWithFlags.Group, for: Any do
  def in?(_, _), do: false
end
